# Полный CI/CD скрипт для локального тестирования с автоматической вставкой пароля
...
Write-Host "=== CI/CD Локальное тестирование (автоматическая вставка пароля) ===" -ForegroundColor Green
