# Упрощенный скрипт для настройки sudo без пароля
# Автор: CI/CD Assistant

Write-Host "=== Настройка sudo без пароля (упрощенная) ===" -ForegroundColor Green

# Создаем правильную конфигурацию sudoers
$sudoersContent = @"
...
$sudoersContent | Out-File -FilePath $tempFile -Encoding UTF8 -NoNewline
